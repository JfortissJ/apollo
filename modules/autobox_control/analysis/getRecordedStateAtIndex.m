...
for i=1:TRAJ_SIZE
    ...
    trajectory.z(i) = cda.res.Trajectory.z.(number)(idx);
end
...
localization.AngularVelocity.x = cda.res.Localization.Pose.AngularVelocity.x(idx);
localization.AngularVelocity.y = cda.res.Localization.Pose.AngularVelocity.y(idx);
localization.AngularVelocity.z = cda.res.Localization.Pose.AngularVelocity.z(idx);
localization.AngularVelocityVrf.x = 0*cda.res.Localization.Pose.AngularVelocity.x(idx); %cda.res.Localization.Pose.AngularVelocityVrf.x(idx);
localization.AngularVelocityVrf.y = 0*cda.res.Localization.Pose.AngularVelocity.x(idx); %cda.res.Localization.Pose.AngularVelocityVrf.y(idx);
localization.AngularVelocityVrf.z = 0*cda.res.Localization.Pose.AngularVelocity.x(idx); %cda.res.Localization.Pose.AngularVelocityVrf.z(idx);
...
localization.LinearAcceleration.z = cda.res.Localization.Pose.LinearAcceleration.z(idx);
localization.LinearAccelerationVrf.x = 0*cda.res.Localization.Pose.LinearAcceleration.x(idx); %cda.res.Localization.Pose.LinearAccelerationVrf.x(idx);
localization.LinearAccelerationVrf.y = 0*cda.res.Localization.Pose.LinearAcceleration.y(idx); %cda.res.Localization.Pose.LinearAccelerationVrf.y(idx);
localization.LinearAccelerationVrf.z = 0*cda.res.Localization.Pose.LinearAcceleration.z(idx); %cda.res.Localization.Pose.LinearAccelerationVrf.z(idx);
...
localization.LinearVelocity.z = cda.res.Localization.Pose.LinearVelocity.z(idx);
localization.Orientation.qw = cda.res.Localization.Pose.Orientation.qw(idx);
localization.Orientation.qx = cda.res.Localization.Pose.Orientation.qx(idx);
localization.Orientation.qy = cda.res.Localization.Pose.Orientation.qy(idx);
localization.Orientation.qz = cda.res.Localization.Pose.Orientation.qz(idx);
...
localization.Position.z = cda.res.Localization.Pose.Position.z(idx);
...
vehicle_data_can.Motion.CRC = 0* cda.res.VehicleDataCan.Motion.LateralAcceleration(idx); %cda.res.VehicleDataCan.Motion.CRC(idx);
vehicle_data_can.Motion.Counter = 0*cda.res.VehicleDataCan.Motion.LateralAcceleration(idx); %cda.res.VehicleDataCan.Motion.Counter(idx);
vehicle_data_can.Motion.LateralAcceleration = cda.res.VehicleDataCan.Motion.LateralAcceleration(idx);
vehicle_data_can.Motion.LongitudinalAcceleration = cda.res.VehicleDataCan.Motion.LongitudinalAcceleration(idx);
vehicle_data_can.Motion.VehicleVelocity = cda.res.VehicleDataCan.Motion.VehicleVelocity(idx);
vehicle_data_can.Motion.YawRate = cda.res.VehicleDataCan.Motion.YawRate(idx);
vehicle_data_can.Motion.YawRateSign = cda.res.VehicleDataCan.Motion.YawRateSign(idx);
vehicle_data_can.Steering.CRC = 0*cda.res.VehicleDataCan.Motion.LateralAcceleration(idx); %cda.res.VehicleDataCan.Steering.CRC(idx);
vehicle_data_can.Steering.Counter = 0*cda.res.VehicleDataCan.Motion.LateralAcceleration(idx); %cda.res.VehicleDataCan.Steering.Counter(idx);
vehicle_data_can.Steering.SteeringWheelAngle = cda.res.VehicleDataCan.Steering.SteeringWheelAngle(idx);
vehicle_data_can.Steering.SteeringWheelAngleSign = cda.res.VehicleDataCan.Steering.SteeringWheelAngleSign(idx);
vehicle_data_can.Steering.SteeringWheelSpeed = cda.res.VehicleDataCan.Steering.SteeringWheelSpeed(idx);
vehicle_data_can.Steering.SteeringWheelSpeedSign = cda.res.VehicleDataCan.Steering.SteeringWheelSpeedSign(idx);
vehicle_data_can.Steering.SteeringWheelTorque = cda.res.VehicleDataCan.Steering.SteeringWheelTorque(idx);
vehicle_data_can.Steering.SteeringWheelTorqueSign = cda.res.VehicleDataCan.Steering.SteeringWheelTorqueSign(idx);
